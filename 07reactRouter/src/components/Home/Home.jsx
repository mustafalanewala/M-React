  ...
  return (
    <div className="mx-auto w-full max-w-7xl">
      ...
      <h1 className="text-center text-2xl sm:text-5xl py-10 font-medium">
        ...
        corrupti aspernatur natus cupiditate autem.
      </h1>
      ...
      <section className="bg-gray-50 py-16">
        ...
        <div className="grid gap-8 sm:grid-cols-3 px-4 sm:px-16">
          ...
          <div className="p-6 bg-white shadow-md rounded-lg hover:shadow-lg transition-shadow duration-300">
            ...
            <p className="text-gray-600">
              Pellentesque vehicula augue eget urna varius cursus.
            </p>
          </div>
          <div className="p-6 bg-white shadow-md rounded-lg hover:shadow-lg transition-shadow duration-300">
            <h3 className="text-xl font-semibold mb-4">Feature Three</h3>
            <p className="text-gray-600">
              Curabitur tincidunt nisl ac tortor interdum malesuada.
            </p>
          </div>
        </div>
      </section>
